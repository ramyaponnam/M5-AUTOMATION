...
public class TC_03_Men 
{
	...
	public void Register()
	{
		...
		// indentify the Login page and click
		driver.findElement(By.id("Login")).click();
		driver.findElement(By.id("searchBtn")).click();
		// identify the mens module and click
		driver.findElement(By.name("men")).click();
		// identify the add to cart and click
		driver.findElement(By.xpath("//span[text()='levis']/../../div[2]/button")).click();
		Reporter.log("Men is added to cart succssfully");
		driver.quit();
